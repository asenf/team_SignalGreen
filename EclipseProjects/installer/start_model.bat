@ECHO OFF
TITLE trafficSimulation_SignalGreen
...
CD trafficSimulation_SignalGreen

REM Start the Model
START javaw -Xss10M -Xmx400M -cp %CP% repast.simphony.runtime.RepastMain ./trafficSimulation_SignalGreen.rs
