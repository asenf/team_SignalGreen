...
\item We did not make progress on the BDI as plannedr
, so this was left out of the code. The code could be restructured to more neatly implement this if desired.
...
\includegraphics{sourcecode.pdf}
